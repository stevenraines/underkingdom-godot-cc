...
- [x] Feature: Character Customization Sheet
...
- [x] Enhancement: Test mode Expansion
...
- [x] UI/UX: Rename Character sheet Weather tab 
    Weather tab changed to Environment, as it contains the current dates and temp 
- [x] UI/UX: Resistance / Vulnerability cues
...
- [x] Compatibility: Pre-Class Saves
    Old Save Games set player to Human Adventurer (hopefully works!)