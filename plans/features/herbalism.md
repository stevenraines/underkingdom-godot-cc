# Feature: Herbalism
**Goal**: Expand the wild flora the player can find and how it can be used.

---

Players currently can use a "healing herb" to make bandages and potions. Lets add a variety of herbs and flowers so the player can collect them. Plants should grow in specific biomes appropriate to thme (mandrakes and orchids in marsh for instance.) Use the variant features creating these from a base herb, base flower, and base mushroom.
